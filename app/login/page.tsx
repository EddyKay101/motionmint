...
export default function LoginPage() {
  ...
  return <main className="auth-page"><section className="auth-art"><Link className="auth-brand" href="/">Turnbine<i /></Link><div><p>YOUR IDEAS, IN MOTION</p><h1>Create once.<br /><em>Move everywhere.</em></h1><div className="auth-mini-banner"><span>9:16 · SOCIAL STORY</span><b>Make the<br />moment move.</b><i /></div></div><small>Private projects · Secure sessions · Your creative space</small></section>
    <section className="auth-panel"><div className="auth-card"><p className="auth-eyebrow">Turnbine account</p><h2>{mode === "login" ? "Welcome back." : "Create your account."}</h2><p className="auth-copy">{mode === "login" ? "Sign in to continue building and saving your projects." : "Register to keep projects connected across devices."}</p>
      ...
      <Link className="auth-back" href="/">← Back to Turnbine</Link></div></section></main>;
}
